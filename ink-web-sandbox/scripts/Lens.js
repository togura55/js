...
//		this.normalizeTransform(scale);
		this.transform = scale;	// use this instead of normalizeTransform for avoiding position adjustment
	}
...
//		this.normalizeTransform(translation);
		this.transform = translation; 	// use this instead of normalizeTransform for avoiding position adjustment
	}
