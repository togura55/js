...
//			this.splitArea = this.splitArea.intersect(this.canvasBridge.canvas.bounds); // added for Safari compatibility
			// history.add();
...
//		dirtyArea = dirtyArea.intersect(this.canvasBridge.canvas.bounds);  // added for Safari compatibility
